...
```javascript
import linspace from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-linspace@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-linspace/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-linspace/actions/workflows/test.yml?query=branch:v0.2.2
